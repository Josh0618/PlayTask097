...
public class DailyTasksFragment extends Fragment {
    ...
    private ArrayList<Mission> dailyTasks = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // 创建并设置适配器
        missionAdapter = new MissionAdapter(dailyTasks);
                ...
                result -> {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if (data != null){
                            ...
                            dailyTasks.add(new Mission(name, point, times));
                            missionAdapter.notifyItemInserted(dailyTasks.size());
                        }
